...
import type { PracticeMode } from "./components/VideoPlayer";
import "./App.css";
...
function App() {
  ...
  const hideDebug = activeMode === "DICTATION";
        ...
        <>
          ...
          {sessionSummary && (
            <div className="session-summary">
              ...
              <p>
                연습 문장 수: <span>{sessionSummary.totalAttempts}</span>
              </p>
              <p>
                평균 점수: <span>{sessionSummary.avgScore}</span>
              </p>
              <p>
                최고 점수: <span>{sessionSummary.bestScore}</span>
              </p>
              <p>
                가장 어려웠던 문장: <span>{sessionSummary.weakestItemId}</span>
              </p>
            </div>
          )}
